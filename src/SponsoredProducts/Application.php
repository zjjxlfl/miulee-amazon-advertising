...
class Application extends Container
{
    ...
    protected $providers = [
        ...
        ProductTargetingRecommendationsV3\ServiceProvider::class,
        ...
        CampaignNegativeTargetsV3\ServiceProvider::class,
        CampaignNegativeKeywordsV3\ServiceProvider::class,
